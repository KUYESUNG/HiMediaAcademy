...
import com.ohgiraffers.restapi.section02.responseentity.ResponserMessage;
...
public class ValidTestController {
    ...
    public ResponseEntity<ResponserMessage> findUserByNo(@PathVariable int userNo) throws UserNotFoundException {
