...
public class MenuController {
    ...
    public String selectMenu (MenuDTO selectMenu, RedirectAttributes rttr) {

        menuService.selectMenu(selectMenu);

        rttr.addFlashAttribute("successMessage", "선택한 메뉴 정보 출력!");

        return "menu/selectlist";
    }
