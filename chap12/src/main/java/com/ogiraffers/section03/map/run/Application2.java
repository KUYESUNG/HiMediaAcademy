package com.ogiraffers.section03.map.run;
...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        prop.setProperty("url", "jdbc:musql://localhost/menu");
        prop.setProperty("user", "ogiraffers");
        prop.setProperty("password", "ogiraffers");
