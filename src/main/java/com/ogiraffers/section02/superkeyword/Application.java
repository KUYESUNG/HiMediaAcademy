package com.ogiraffers.section02.superkeyword;
...
public class Application {
    ...
    public static void main(String[] args) {
         ...
         *           부모의 생성자를 호출하게 된다. this()가 해당 클래스 내의 다른 생성자를 호출하는 구문이라면,
        ...
        Product product2 = new Product("5-01234", "삼성", "갤럭시z폴드2", 2398000,new java.util.Date());
        ...
        Computer computer3 = new Computer("5-01234", "삼성", "갤럭시z폴드2", 23980000, new java.util.Date(),
