...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        * 본인의 상태를 스스로 제어하고 행동하도록 한다는 것이 현실 세계와는 다른 점이다.
        ...
        * */
        ...
        /* 객체와 객체의 상호작용이란?
        * 객체와 객체는 메시지를 통해 서로 상호작용을 한다. 메시지(메소드 호츌)를 보내는 쪽을 송신자라고 하고
        * 메시지를 수신하는 쪽은 수신자라고 한다. 수신자는 메시지를 전달 받아 그 메세지에 해당하는 내용을 처리하는 방법을
        * 스스로 결정하고, 그 결정한 방법 대로 처리할 명령어들을 순차적으로 기술한 것을 메소드라고 한다.
        * 상호작용에 중요한 것은 메세지를 송수신 하고 그 방법을 기술하여 메세지에 응답하는 상호작용을 설계하는 것이다.
        * 따라서 객체를 설계할 때는 속성을 부가적이며 적절한 책임을 가진 객체들간의 주고 받는 메세지를 이용해 상호작용하는 것을
        * 설계하는 것을 의미한다.
