...
//        4. 사파리 차는 멈춰있는 상태이다.
//        5. 관람자는 차에 탑승한다.
//        6. 사파리 차는 앞 뒤로 움직임 그리고 멈추기가 가능하다.
//        7. 차가 동물의 서식지에 들어오면 해당 동물은 차를 보며 포효를 한다.
//        (동물은 곰, 늑대, 호랑이가 존재하며 각 3~4, 5~6, 7~8키로미터의 위치에 서식지가 존재한다)
//        8. 관람자는 동물에게 먹이를 줄수있다.
//        9. 동물은 랜덤으로 먹이를 먹을지 안먹을지 정해진다.
//        10. 오로지 출구로만 탐험을 끝 마칠수 있다.
//
//        차가 해야 할 일
//        1. 앞으로 가기
//        2. 뒤로 가기
