...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        * 1-5. 특수기호는 '_'와 '$'만 사용 가능하다. (공백은 사용할 수 없다.)
        *
        * 2.컴파일 에러를 발생시키지는 않지만 개발자들끼리의 암묵적인 규칙
        * 2-1. 변수명의 길이 제한은 없다.
        * 2-2. 변수명이 합성어로 이루어진 경우 첫 단어는 소문자, 두 번재 시작 단어는 대문자로 시작한다(camel-case)
        ...
        * */
        ...
        /* 1. 컴파일 에러를 발생시키는 규칙*/
        /* 목차 1-1. 동일한 범위 내에서 동일하나 변수명을 가질 수 없다. */
        int age = 20;
//        int age = 20;
...
//        int sh@rp = 20;
        ...
        /* 2. 컴파일 에러를 발생시키지는 않지만 개발자들끼리의 암묵적인 규칙 */
        /* 목차 2-1. 변수명의 길이는 제한은 없다. 하지만 적당히 하자 */
        int fasklfjslkajklzvlkvafasfsjk;
