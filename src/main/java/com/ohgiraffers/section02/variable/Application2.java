...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        * 예) 앞에서 사용한 int 자료형은정수 4byte만큼을 읽어서 하나의 값으로 취급하겠다는 약속이다.
        *     이러한 자료형은 기본자료형(Primary type)과 참조자료형(Reference type)으로 나누어진다.
        * 그 중 기본자로형 8가지부터 살펴보기로 한다.
        * */
        ...
        * */
        ...
        snum = 2;
        inum = 4;
        lnum = 8L;  // 소문자 l로 써도 되지만 글꼴에 다라 숫자 1과 혼선이 빚어질 수 있어서 대문자로 하는 것이 권장한다.
