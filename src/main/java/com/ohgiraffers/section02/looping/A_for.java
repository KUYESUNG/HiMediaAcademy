...
public class A_for {
    ...
    public void temtSimpleStatement() {
        /* 수업목표. for문 단독사용에 대한 흐름에 이해하고 적용할 수 있다. */
        /* 필기.
        * [for문 표현식]
        * for(초기식; 조건식; 증감식) {
    ...
    public void testForExampl2() {

        /* 1~10까지 1씩 증가시키면서 증가시키는 값을 저장할 변수에 계속 누적시켜 변수에
         저장된 값을 출력하시오 */
