...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *  추상클래스 사용하려면 추상클래스를 상속받은 하위 클래스를 이용해서 인스턴스를 생성해야 한다.
        ...
        *  다형성이 적용되며 동적바인딩에 의해 다양한 응답을 할 수 있게 된다.
        *
        ...
        *  추상메소드는 경우 반드시 abstract 키워드를 메소드 헤드에 작성해야 한다.
...
//        Product product = new Product();      // 추상클래스는 인스턴스 생성 불가
        ...
        *
        *  추상클래스보다 더 강제성이 강한 인터페이스(interface)라는 메커니즘을 제공하고 있다.
        * */
    }
}
