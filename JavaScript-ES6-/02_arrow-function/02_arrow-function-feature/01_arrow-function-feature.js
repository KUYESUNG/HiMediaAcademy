// 02_화살표 함수의 특징
// 화살표 함수는 기존의 함수보다 표현만 간략한 것이 아니라 내부 동작 또는 간략화 되어 있다.
...
let theater = {
    ...
    //         console.log(this.store + ':' + this.title); 
    //     });
    // }
};
...
// 화살표 함수는 argument를 지원하지 않는다.
// 화살표 함수는 본인의 argumnets 3,4가 아닌 상위 스코프인 즉시 실행 함수의 arguments 1,2를 참조한다.
(function() {
