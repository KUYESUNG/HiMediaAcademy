package com.ogiraffers.section03.filterstream;

import com.ogiraffers.section03.filterstream.dto.MemberDTO;
...
public class Application4 {
    ...
    public static void main(String[] args) {
        ...
        try {
            objOut = new ObjectOutputStream(new BufferedOutputStream(new FileOutputStream("src/main/java/com/ogiraffers/section03/filterstream/testObjectStream.txt")));
        ...
        try {
            objIn = new ObjectInputStream(new BufferedInputStream(new FileInputStream("src/main/java/com/ogiraffers/section03/filterstream/testObjectStream.txt")));
